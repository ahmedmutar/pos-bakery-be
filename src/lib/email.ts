    ...
    <div class="body">
      ...
      <div class="info-row" style="border:0">
        ...
        <span class="info-value">
          <a href="https://wa.me/${process.env.ADMIN_WHATSAPP ?? '6285947566558'}?text=Halo+${encodeURIComponent(params.ownerName)},+selamat+datang+di+Roti+POS!+Saya+dari+tim+support.+Ada+yang+bisa+saya+bantu?" 
